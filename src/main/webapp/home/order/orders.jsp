				...
				<tr>
					...
					<td>
						<div class="order-cancel">
							<form action="/order/modify.html" method="post" onsubmit="return confirmAction(this.BTN.value, ${order.order_status})">
							<input type="hidden" name="orderNo" value="${order.order_no }">
							<input type="submit" name="BTN" value="주문취소" onclick="return confirmCancel()">
							</form>
							<form action="/order/returnRequest.html" method="post" id="returnForm${order.order_no}">
							<input type="hidden" name="order_no" value="${order.order_no }">
							<input type="submit" name="BTN" value="반품신청" id="returnBtn${order.order_no}" onclick="return confirmReturn(${order.order_status}, ${order.order_no})">
							</form>
						</div>
					</td>
					<td>
