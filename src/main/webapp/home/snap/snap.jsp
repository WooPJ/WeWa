	    ...
	    <div class = "snap_content_box">
               ...
               <div class="user_navi">
                ...
                <div class = "stored_post_page">
  				...
  				<!-- 프로필 및 작성게시글 -->  				                
                <div class = "tag_post_page">
                
                
                    <div class = "tag_line">
                        <div class = "tag_box">
                            <img class = "tag_img" src = "img/tag_img1.jpg">
                        </div>
                        <div class = "tag_box">
                            <img class = "tag_img" src = "img/tag_img2.jpg">
                        </div>
                        <div class = "tag_box">
                            <img class = "tag_img" src = "img/tag_img3.jpg">
                        </div>
                    </div>
                    <div class = "tag_line">
                        <div class = "tag_box">
                            <img class = "tag_img" src = "img/tag_img4.jpg">
                        </div>
                        <div class = "tag_box">
                            <img class = "tag_img" src = "img/tag_img5.jpg">
                        </div>
                        <div class = "tag_box">
                            <img class = "tag_img" src = "img/tag_img6.jpg">
                        </div>
                    </div>
                </div>
