	    ...
	    <div class = "snap_content_box">
               ...
               <div class="user_navi">
                   <a class="posting" onclick="show_Posting()">
                       <svg class="navi_img" aria-label=""  fill="currentColor" height="12" role="img" viewBox="0 0 24 24" width="12"><title></title><rect fill="none" height="18" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" width="18" x="3" y="3"></rect><line fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" x1="9.015" x2="9.015" y1="3" y2="21"></line><line fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" x1="14.985" x2="14.985" y1="3" y2="21"></line><line fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" x1="21" x2="3" y1="9.015" y2="9.015"></line><line fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" x1="21" x2="3" y1="14.985" y2="14.985"></line></svg>
                       <span>&nbsp;게시물</span>  
                   </a>
                   ...
                   <a class="tag_post" onclick="show_Tag()">
...
<!-- 피드게시물 -->
                <div class = "posting_page"> 
                    ...
                    <div class = "posting_line">
                        <div class = "posting_box">
                            <img class = "posting_img" src = "img/feed_img4.jpg">
                        </div>
                        <div class = "posting_box">
                            <img class = "posting_img" src = "img/feed_img5.jpg">
                        </div>
                        <div class = "posting_box">
                            <img class = "posting_img" src = "img/feed_img6.jpg">
                        </div>
                    </div>
                    <div class = "posting_line">
                        <div class = "posting_box">
                            <img class = "posting_img" src = "img/feed_img7.jpg">
                        </div>
                        <div class = "posting_box">
                            <img class = "posting_img" src = "img/feed_img8.jpg">
                        </div>
                        <div class = "posting_box">
                            <img class = "posting_img" src = "img/feed_img9.jpg">
                        </div>
                    </div>
                    <div class = "posting_line">
                        <div class = "posting_box">
                            <img class = "posting_img" src = "img/feed_img10.jpg">
                        </div>
                        <div class = "posting_box">
                            <img class = "posting_img" src = "img/feed_img11.jpg">
                        </div>
                        <div class = "posting_box">
                            <img class = "posting_img" src = "img/feed_img12.jpg">
                        </div>
                    </div>
                    <div class = "posting_line">
                        <div class = "posting_box">
                            <img class = "posting_img" src = "img/feed_img13.jpg">
                        </div>
                        <div class = "posting_box">
                            <img class = "posting_img" src = "img/feed_img14.jpg">
                        </div>
                        <div class = "posting_box">
                            <img class = "posting_img" src = "img/feed_img15.jpg">
                        </div>
                    </div>
                </div>
